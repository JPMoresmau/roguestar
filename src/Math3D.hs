...
-- |
-- Objects that are subject to affine transformations using matrix multiplication.
-- Transform is the only required function. 
-- Scale, translate, and rotate may optionally be provided for efficiency.
-- Note: Most types in Math3D implement specialized scale and translate, but not rotate.
--
