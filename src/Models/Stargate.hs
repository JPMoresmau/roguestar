    ...
    do model $ 
           do model $
                  do box (Point3D (-0.6) 0 (-0.05)) (Point3D (-0.5) 1.618 0.05)
                     ...
                     box (Point3D (-1.1) 1.568 (-0.05)) (Point3D (1.1) 1.668 0.05)
                     minorFixedQuality q
              let cone = 
                      do openCone (Point3D 0 (1.618/3) 0,0) (Point3D 0 (1.618/6) 0,0.4)
                         openCone (Point3D 0 0 0,0) (Point3D 0 (1.618/6) 0,0.4)
